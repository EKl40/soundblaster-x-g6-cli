...
CLI_CASES.append(("sbx_slider", lambda: ["--sbx-bass-value", "0"]))
CLI_CASES.append(("sbx_slider", lambda: ["--sbx-bass-value", "42"]))
CLI_CASES.append(("sbx_slider", lambda: ["--sbx-bass-value", "100"]))
