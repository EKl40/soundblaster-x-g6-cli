...
CLI_CASES.append(("mixer_monitoring_line_in_volume", lambda: ["--mixer-monitoring-line-in-volume", "37"]))
...
CLI_CASES.append(("mixer_monitoring_external_mic_volume", lambda: ["--mixer-monitoring-external-mic-volume", "12"]))
...
CLI_CASES.append(("mixer_monitoring_spdif_in_volume", lambda: ["--mixer-monitoring-spdif-in-volume", "88"]))
...
CLI_CASES.append(("mixer_recording_line_in_volume", lambda: ["--mixer-recording-line-in-volume", "61"]))
...
CLI_CASES.append(("mixer_recording_external_mic_volume", lambda: ["--mixer-recording-external-mic-volume", "73"]))
...
CLI_CASES.append(("mixer_recording_spdif_in_volume", lambda: ["--mixer-recording-spdif-in-volume", "9"]))
...
CLI_CASES.append(("mixer_recording_what_u_hear_volume", lambda: ["--mixer-recording-what-u-hear-volume", "44"]))
